          ...
          <Card mt="16px" style={{ overflow: 'unset' }} mb={isDesktop ? '0' : '24px'}>
            <Box padding={16}>
                  ...
                  <BenefitsTooltipsText
                    ...
                    tooltipComponent={
                      <>
                        ...
                        <LinkExternal href="https://docs.dgswap.io/products/revenue-sharing/faq#50b7c683-feb0-47f6-809f-39c1a0976bb5">
              ...
              <LinkExternal
                ...
                href="https://docs.dgswap.io/products/revenue-sharing"
              >
                {t('Learn More')}
              </LinkExternal>
            </Box>
