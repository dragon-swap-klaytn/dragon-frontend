...
const FEE_TIERS = [FeeAmount.LOWEST, FeeAmount.LOW, FeeAmount.MEDIUMLOW, FeeAmount.MEDIUM, FeeAmount.HIGH, FeeAmount.HIGHEST]
  ...
  const pools = usePools(
    useMemo(
      () => [
        ...
        [currencyA, currencyB, FeeAmount.MEDIUMLOW],
    ...
    () =>
      pools.reduce(
        ...
        },
        {
          ...
          [FeeAmount.MEDIUMLOW]: PoolState.NOT_EXISTS,
