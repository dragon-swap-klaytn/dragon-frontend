...
const LIQUIDITY_FILTER = { [ChainId.BSC]: 100000, [ChainId.ETHEREUM]: 50000, [ChainId.KLAYTN]: 10000 }
      ...
      <Wrapper>
        <MenuWrapper>
          <ButtonMenu activeIndex={index} onItemClick={setIndex} fullWidth scale="sm" variant="subtle">
            <ButtonMenuItem>{chainId === DEFAULT_CHAIN_ID ? t('Price Change') : t('Liquidity')}</ButtonMenuItem>
        ...
        {index === 0 ? (
          <TokenTable
            ...
            type={chainId === DEFAULT_CHAIN_ID ? 'priceChange' : 'liquidity'}
            defaultSortField={chainId === DEFAULT_CHAIN_ID ? 'priceUSDChange' : 'liquidityUSD'}
