  ...
  return (
    <RouterBox justifyContent="space-between" alignItems="center">
      <CurrencyLogoWrapper ref={targetRef}>
        <CurrencyLogo size={44} currency={inputCurrency} />
      </CurrencyLogoWrapper>
      ...
      {pairs &&
        ...
        pairs.map((p, index) => {
          ...
          return (
            ...
            >
              <CurrencyLogo size={32} currency={index === 0 ? inputCurrency : path[index]} />
              <CurrencyLogo size={32} currency={index === pairs.length - 1 ? outputCurrency : path[index + 1]} />
      ...
      <CurrencyLogoWrapper ref={outputTargetRef}>
        <CurrencyLogo size={44} currency={outputCurrency} />
      </CurrencyLogoWrapper>
