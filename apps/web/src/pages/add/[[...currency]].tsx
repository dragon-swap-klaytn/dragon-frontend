...
const AddLiquidityPage = () => {
  ...
  */
  ...
  const { farmsV2, farmsV3 } = useFarmPrivateAPI()
  ...
  const preferFarmType = useMemo(() => {
    ...
    const hasV3Farm = farmsV3.find(
      (farm) =>
        farm.multiplier !== '0X' &&
        ((farm.token0.equals(currencyA.wrapped) && farm.token1.equals(currencyB.wrapped)) ||
          (farm.token1.equals(currencyA.wrapped) && farm.token1.equals(currencyB.wrapped))),
    )
