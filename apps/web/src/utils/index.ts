...
export function getChainIcon(chainId: ChainId) {
  return (
    {
      8217: 'https://klaytn.foundation/wp-content/uploads/2022/12/cropped-favicon-180x180.png',
      1001: 'https://klaytn.foundation/wp-content/uploads/2022/12/cropped-favicon-180x180.png',
