...
export const v2TokensAccDataCache = createLocalLRUCache<TokenAccDataCache>({ maxSize: 1_024 })
export const v3TokensAccDataCache = createLocalLRUCache<TokenAccDataCache>({ maxSize: 1_024 })
