import { PoolV2AccData, PoolV3AccData, TokenAccData } from 'lib/graph-queries/types'
...
export const v2TokensAccDataCache = createLocalLRUCache<{ [id: string]: Omit<TokenAccData, 'id'> }>({ maxSize: 2_000 })
export const v3TokensAccDataCache = createLocalLRUCache<{ [id: string]: Omit<TokenAccData, 'id'> }>({ maxSize: 2_000 })
