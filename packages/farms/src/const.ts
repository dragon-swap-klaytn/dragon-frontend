...
export const supportedChainIdV2 = [ChainId.KLAYTN, ChainId.KLAYTN_TESTNET] as const
export const supportedChainIdV3 = [ChainId.KLAYTN, ChainId.KLAYTN_TESTNET] as const
export const supportedChainId = uniq([...supportedChainIdV2, ...supportedChainIdV3])
export const bCakeSupportedChainId = [] as number[]
